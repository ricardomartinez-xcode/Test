...
Estado: historico. Los hallazgos de esta lista guiaron fases anteriores; el estado operativo vigente esta en `docs/OPERATIONS_RUNBOOK.md` y `docs/QA_CHECKLIST.md`.
...
- **R2 inconsistente:** resuelto en la fase operativa. La raiz vigente es el bucket `psicologia`; las carpetas esperadas salen de R2, Supabase y `DEFAULT_R2_FOLDER_DESTINATIONS`.
